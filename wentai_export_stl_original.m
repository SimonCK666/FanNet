function out = model
%
% wentai_export_stl_original.m
%
% Model exported on Dec 31 2021, 17:46 by COMSOL 5.5.0.292.
...
model.component('comp1').physics('solid').feature('bndl1').set('FperArea', [0 100000000 0]);
...
model.label('wentai_finally.mph');
...
model.component('comp1').mesh('mesh1').export.set('filename+', 'wentai_mesh_test2');
model.component('comp1').mesh('mesh1').export('wentai_mesh_test2.stl');
model.component('comp1').mesh('mesh1').export('wentai_mesh_test2.stl');
...
%pdmesh.p = d.vertex;
%pdmesh.t = d.elem{idx};
%mphwritest1('wentai_mesh_text2.stl', pdmesh);
