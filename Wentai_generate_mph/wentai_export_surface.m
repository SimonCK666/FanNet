...
%
% wentai_export_surface.m
%
% Model exported on Jan 3 2022, 13:44 by COMSOL 5.5.0.292.
...
% surface_basic = 'D:\Comsol_Matlab_Test\FanNet\wentai_export\surface\surface_';
surface_suffix = '.txt';

report_basic = 'D:\Comsol_Matlab_Test\FanNet\wentai_export\report\wentai_report_';
report_suffix = '.docx';
...
for i = 1:100
    ...
    model.label('wentai_test_m1.mph');
    ...
    mph_base = 'D:\Comsol_Matlab_Test\FanNet\wentai_export\mph\wentai_test_m';
    name_full = sprintf("%s%s", mph_base, string_i);
    name_suffix = ".mph";
    name = sprintf("%s%s", name_full, name_suffix);
    
    model.label(name);
    % model.label('wentai_test_m1.mph');
    mphsave(model, name_full);
    ...
    model.result.report('rpt1').feature('sec4').feature('sec2').feature('sec1').set('heading', [native2unicode(hex2dec({'5e' '94'}), 'unicode')  native2unicode(hex2dec({'52' '9b'}), 'unicode') ' (solid)']);
    ...
    model.result.report('rpt1').feature('sec4').feature('sec3').set('heading', [native2unicode(hex2dec({'59' '16'}), 'unicode')  native2unicode(hex2dec({'52' 'a0'}), 'unicode')  native2unicode(hex2dec({'8f' '7d'}), 'unicode')  native2unicode(hex2dec({'83' '77'}), 'unicode') ' (solid)']);
    ...
    model.result.report('rpt1').feature('sec4').feature('sec3').feature('sec1').set('heading', [native2unicode(hex2dec({'8f' 'b9'}), 'unicode')  native2unicode(hex2dec({'75' '4c'}), 'unicode')  native2unicode(hex2dec({'8f' '7d'}), 'unicode')  native2unicode(hex2dec({'83' '77'}), 'unicode') ' (solid)']);
    model.result.report('rpt1').feature('sec4').feature('sec3').feature('sec1').create('pg1', 'PlotGroup');
    model.result.report('rpt1').feature('sec4').feature('sec3').feature('sec1').feature('pg1').set('noderef', 'pg2');
    model.result.report('rpt1').set('format', 'docx');
    
    str_i = num2str(i);
    report_name_full = sprintf("%s%s%s", report_basic, str_i, report_suffix);
    model.result.report('rpt1').set('filename', report_name_full);
    ...
    % set surface & report name
    % str_i = num2str(i);
    surface_name_full = sprintf("%s%s%s", surface_basic, str_i, surface_suffix);
    %report_name_full = sprintf("%s%s%s", report_basic, str_i, report_suffix);
    
    %model.result.export('plot1').set('filename', 'D:\Comsol_Matlab_Test\FanNet\wentai_export\surface.txt');
    model.result.export('plot1').set('filename', surface_name_full);
    %model.result.report('rpt1').set('filename', 'D:\Comsol_Matlab_Test\FanNet\wentai_export\wentai_report.docx');
    model.result.report('rpt1').set('filename', report_name_full);
