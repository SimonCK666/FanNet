...
% wentai_export_stl.m
%
% Model exported on Dec 31 2021, 17:29 by COMSOL 5.5.0.292.
...
for i = 1:2
    ...
    stlName = sprintf("%s%s", name_full, stlname_suffix);
    ...
    model.component('comp1').mesh('mesh1').export.set('filename', name_full);
    model.component('comp1').mesh('mesh1').export(stlName);
    model.component('comp1').mesh('mesh1').export(stlName);
    
    mphsave(model, name_full); % save mph file
